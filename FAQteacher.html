...
<head>
  ...
  <link rel="stylesheet" href="css/styleFAQteacher.css">
    ...
    <div class="row">
      ...
      <main class="container py-5">
        <div class="mx-auto px-3" style="max-width: 800px;">
          ...
          <!-- タイトルと新規追加ボタン（レスポンシブ対応） -->
          <div
            class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
            <h2 class="mb-0">FAQ管理画面（管理者）</h2>
          </div>
          ...
          <ul class="list-group shadow">
            <li
              ...
              <span>行事の予定がわかりません</span>
              <div class="d-flex flex-wrap justify-content-start justify-content-sm-end gap-2">
                <button class="btn btn-sm btn-outline-primary" onclick="location.href='クラス作成画面へのパスを書く'">
                  <i class="fas fa-edit"></i> 編集
                </button>
                <button class="btn btn-sm btn-outline-danger" onclick="location.href='クラス作成画面へのパスを書く'">
