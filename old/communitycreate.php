...
<head>
    ...
    <link rel="stylesheet" href="css/stylecommunitycreate.css">
<body class="bg-light">
  <!--モバイル時ヘッダー-->
  ...
  <div class="container-fluid">
    <div class="row">
      <!-- サイドバー（PCのみ表示） -->
      <nav class="col-2 col-md-2 col-lg-2 d-none d-md-flex flex-column align-items-center sidebar p-0 sidebar-fixed">
